...
CUDA_VISIBLE_DEVICE=0 taskset -c 0-17,36-53 python3 train.py --data=/home/aparen/data/imagenet --batch_size=256 --learning_rate=1.25e-3 --epochs=128 --weight_decay=1e-5 | tee -a log/training.txt
