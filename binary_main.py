...
class Trainer(object):
    def __init__(self, args):
        self.args = args
        assert 'bop' not in args.reg_type
    ...
    def train(self):
        ...
        for epoch in range(self.args.start_epoch, self.args.epochs):
            ...
            if self.args.no_val: # save every epoch
                ...
                if self.args.reg_type == 'ternary' or self.args.reg_type == 'l05_ternary' or self.args.reg_type == 'bnew_binary':
                    if self.reg.epoch in args.freeze_epoch or args.freeze_epoch[0]==0:
