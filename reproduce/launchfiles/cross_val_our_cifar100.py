...
def create_jobs():
    ...
    template = "CUDA_VISIBLE_DEVICES=1 taskset -c 18-31,54-71 python binary_main.py --model rn --dataset cifar100 --proxquant --reg-type our_binary --resume /home/aparen/quantized-scnn/projects/pytorch_fscnn/results/cifar100/rncifar100-adam--lr-step-0.01--wd-0.0--b-256-epoch-200-reg-0.0-type-convex_hull-None/best_model.pkl --relu ste --opt adam --lr_mode step --T 100 150 --epochs 200 --batch-size 256 --freeze 190 191 192 193 194 195 196 197 198 199 200 --use_tensorboard --tag none_zero_reg --train_acc "
...
def list_jobs(template, jobs):
    ...
    with open("gridours.yaml", "r") as f:
