...
def create_jobs():
    ...
    template += "python binary_main.py --dataset cifar100 --proxquant --reg-type binary --resume /home/aparen/quantized-scnn/projects/pytorch_fscnn/results/cifar10/wrncifar10-adam--lr-step-0.01--wd-0.0--b-256-epoch-200-reg-0.0-type-convex_hull-None/best_model.pkl --relu ste --opt adam --lr_mode step --T 100 150 --epochs 200 --batch-size 256 --freeze 190 191 192 193 194 195 196 197 198 199 200 --tag wreg --train_acc "
