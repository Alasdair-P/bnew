...
def create_jobs():
    ...
    template += "python binary_main.py --dataset cifar100  --proxquant --reg-type convex_hull --relu ste --opt adam --lr_mode step --T 100 150 --epochs 1 --batch-size 128 --tag test_please_delete "
...
def list_jobs(template, jobs):
    ...
    with open("reproduce/pretrain_all.yaml", "r") as f:
