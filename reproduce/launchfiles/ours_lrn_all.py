...
def create_jobs():
    ...
    template = "CUDA_VISIBLE_DEVICES=0 taskset -c 0-17,32-53 "
    template += "python binary_main.py --dataset cifar100 --proxquant --reg-type our_binary --resume /home/aparen/quantized-scnn/projects/pytorch_fscnn/results/cifar100/lrncifar100-adam--lr-step-0.01--wd-0.0--b-128-epoch-200-reg-0.0-type-convex_hull-small/best_model.pkl --relu ste --opt adam --lr_mode step --T 100 150 --epochs 200 --batch-size 128 --freeze 190 191 192 193 194 195 196 197 198 199 200 --use_tensorboard --tag ours_final --train_acc "
    list_jobs(template, jobs)

    template = "CUDA_VISIBLE_DEVICES=0 taskset -c 0-17,32-53 "
    template += "python binary_main.py --dataset tiny_imagenet --proxquant --reg-type our_binary --resume /home/aparen/quantized-scnn/projects/pytorch_fscnn/results/tiny_imangenet/lrntiny_imagenet-adam--lr-step-0.01--wd-0.0--b-128-epoch-200-reg-0.0-type-convex_hull-small/best_model.pkl --relu ste --opt adam --lr_mode step --T 100 150 --epochs 200 --batch-size 128 --freeze 190 191 192 193 194 195 196 197 198 199 200 --use_tensorboard --tag ours_final --train_acc "
    list_jobs(template, jobs)
